...
%   \input{00-common-preamble.tex}
  ...
  \texttt{amarshah@cmu.edu, binarynewts@cmu.edu, jereeves@andrew.cmu.edu, marijn@cmu.edu}}
  ...
  \begin{abstract}
    ...
    %
    One of the strongest such techniques is Propagation Redundancy (PR) learning. However, existing \pr clause learning techniques require an NP-hard check. Hence they are computationally expensive and difficult to integrate into existing tools.
