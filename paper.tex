...
%  \newcommand{\cadical}{{\sf CaDiCaL}\xspace}
  ...
  \begin{abstract}
    ...
    Propagation Redundant (PR) clause learning. Solvers utilizing PR clause learning may
  ...
  \input{texs/6.futurework}
  \input{texs/7.conclusion}
  \input{texs/8.acknowledgements}
