...
%  \newcommand{\cadical}{{\sf CaDiCaL}\xspace}
  ...
  \begin{abstract}
    ...
    We show that our method competitive with state-of-the-art \pr clause learning techniques, and improves performance on a large portion of SAT competition benchmarks.
