...
%  \newcommand{\cadical}{{\sf CaDiCaL}\xspace}
  ...
  \begin{abstract}
    ...
    %
    We show that this is competitive with state-of-the-art PR clause learning techniques, and improves performance on a portion of SAT competition benchmarks.
