...
%   \input{00-common-preamble.tex}
  ...
  \begin{document}
  \title{Learning Short SAT Clauses by Conditional Autarkies}
  
  % \author{TODO: add authors and orcid \\
  \author{Amar Shah \orcidlink{0009-0008-8282-2142}, Twain Byrnes \orcidlink{}, Joseph Reeves \orcidlink{}, Marijn J.\ H.\ Heule \orcidlink{0000-0002-5587-8801} \\
  ...
  \begin{abstract}
    ...
    We show that we are competitive with state-of-the-art \pr clause learning techniques on a suite of SAT instances, improving the performance on a large portion of SAT competition benchmarks.
