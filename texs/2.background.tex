...
$\formula$. A assignment $\alpha : V \rightarrow \{\top, \bot\}$ on
...
A formula restricted to a assignment $\formula|_\alpha$ is the formula
...
In plain words, an autarky is a assignment that satisfies every clause it
touches.
...
% looking for a assignment $\alpha_c$, and then finding an autarky
